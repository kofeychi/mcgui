package dev.kofeychi.mcgui.resource.types;

import dev.kofeychi.mcgui.resource.Id;
import dev.kofeychi.mcgui.resource.PackSource;
...
public class InjarPackSource implements PackSource {
    ...
    public String target() {
        return "pack" + "/" + type.folder + "/" + path.asOsPath();
    }

    @Override
    public PackSource resolve(Id path) {
        return new InjarPackSource(jfFile, id, path, type,!path.path.contains("."));
    }
